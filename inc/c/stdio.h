...
#pragma rtmodel="__dlib_file_descriptor",_STRINGIFY(_DLIB_FILE_DESCRIPTOR)
  ...
  #if _DLIB_FILE_DESCRIPTOR
    _C_LIB_DECL
    _DLIB_DATA_ATTR FILE extern *__stm8abi_stdin; 
    _DLIB_DATA_ATTR FILE extern *__stm8abi_stdout;
    _DLIB_DATA_ATTR FILE extern *__stm8abi_stderr;
    _END_C_LIB_DECL
    #define stdin          _CSTD __stm8abi_stdin
    #define stdout         _CSTD __stm8abi_stdout
    #define stderr         _CSTD __stm8abi_stderr
  #endif /* _DLIB_FILE_DESCRIPTOR */

  _C_LIB_DECL
  _DLIB_CONST_ATTR extern int const __stm8abi_IOFBF;
  _DLIB_CONST_ATTR extern int const __stm8abi_IOLBF;
  _DLIB_CONST_ATTR extern int const __stm8abi_IONBF;
  _DLIB_CONST_ATTR extern int const __stm8abi_BUFSIZ;
  _DLIB_CONST_ATTR extern int const __stm8abi_FOPEN_MAX;
  _DLIB_CONST_ATTR extern int const __stm8abi_TMP_MAX;
  _DLIB_CONST_ATTR extern int const __stm8abi_FILENAME_MAX;
  _DLIB_CONST_ATTR extern int const __stm8abi_L_tmpnam;
  _END_C_LIB_DECL
  #define _IOFBF          (_CSTD __stm8abi_IOFBF)
  #define _IOLBF          (_CSTD __stm8abi_IOLBF)
  #define _IONBF          (_CSTD __stm8abi_IONBF)
  #define BUFSIZ          (_CSTD __stm8abi_BUFSIZ)
  #define FOPEN_MAX       (_CSTD __stm8abi_FOPEN_MAX)
  #define TMP_MAX         (_CSTD __stm8abi_TMP_MAX)
  #define FILENAME_MAX    (_CSTD __stm8abi_FILENAME_MAX)
  #define L_tmpnam        (_CSTD __stm8abi_L_tmpnam)
...
_C_STD_END
  ...
  #if __STM8ABI_PORTABILITY_INTERNAL_LEVEL
    #if _DLIB_FILE_DESCRIPTOR
      using _CSTD __stm8abi_stdin; using _CSTD __stm8abi_stdout; 
      using _CSTD __stm8abi_stderr;
    #endif /* _DLIB_FILE_DESCRIPTOR */

    using _CSTD __stm8abi_IOFBF; using _CSTD __stm8abi_IOLBF; 
    using _CSTD __stm8abi_IONBF; using _CSTD __stm8abi_BUFSIZ;
    using _CSTD __stm8abi_FOPEN_MAX; using _CSTD __stm8abi_TMP_MAX;
    using _CSTD __stm8abi_FILENAME_MAX; using _CSTD __stm8abi_L_tmpnam;
  #endif
