...
_C_STD_BEGIN
  ...
  _C_LIB_DECL
  _DLIB_CONST_ATTR extern int const __stm8abi_CLOCKS_PER_SEC;
  _END_C_LIB_DECL
  #define CLOCKS_PER_SEC  (_CSTD __stm8abi_CLOCKS_PER_SEC)

  #if _DLIB_TIME_USES_64
    #error("_DLIB_TIME_USES_64 cannot be used together with _STM8ABI_PORTABILITY_LEVEL" )
  #endif
...
_C_STD_END
  ...
  #if __STM8ABI_PORTABILITY_INTERNAL_LEVEL
    using _CSTD __stm8abi_CLOCKS_PER_SEC;
  #endif
